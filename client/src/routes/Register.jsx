    ...
    <div className='flex items-center justify-center h-[100vh]'>
      ...
      <div className='bg-white shadow-xl rounded-lg w-[900px] h-[500px] flex'>
        ...
        <section className='flex-1 bg-blue-500 grid place-items-center rounded-r-lg'>
          <div>
            <p className='text-white text-2xl font-semibold w-[240px]'>Create an Account</p>
            <p className='text-white text-xs mt-1 mb-5'>Welcome</p>

            <form className='' onSubmit={auth}>

              <div>
                <input type="text" className='text-sm border-2 border-white text-white placeholder:text-white/50 bg-blue-500 px-2 py-2 rounded-md mb-5 focus:outline-none w-full' placeholder='Name' onChange={(e) => setInfo({...info, name:e.target.value})} required/>
              </div>
            ...
            <p className='text-white text-xs mt-2'>Already have an account? 
